...
class UnitConfiguration extends Model
{
    ...
    protected $fillable = ['unit_id', 'version', 'status', 'payment_enabled', 'documents_enabled', 'tests_enabled', 'fields', 'document_requirements', 'test_definitions', 'published_at', 'legacy'];

    protected $casts = ['payment_enabled' => 'boolean', 'documents_enabled' => 'boolean', 'tests_enabled' => 'boolean', 'fields' => 'array', 'document_requirements' => 'array', 'test_definitions' => 'array', 'published_at' => 'datetime', 'legacy' => 'boolean'];
