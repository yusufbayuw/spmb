...
class Payment extends Model
{
    ...
    protected $fillable = ['registration_id','va_number','amount','status','payment_date','payment_method','proof_path','proof_original_name','proof_uploaded_at','note','rejection_reason','verified_by','verified_at','va_sent_at','va_sent_by'];
