...
class PaymentResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table->defaultSort('created_at','desc')->columns([
            ...
            Tables\Columns\TextColumn::make('proof_original_name')->label('Bukti')->url(fn(Payment $record)=>$record->proof_path?Storage::disk('public')->url($record->proof_path):null)->default('-'),
