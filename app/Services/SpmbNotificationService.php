...
class SpmbNotificationService
{
    public function registrationSubmitted(Registration $registration): void
    {
        ...
        $this->notify(
            ...
            "Data {$registration->full_name} telah masuk dan menunggu validasi. Nomor registrasi resmi diterbitkan setelah pembayaran diverifikasi.",
            'success',
        ...
        $this->notify(
            ...
            "{$registration->full_name} telah dikirim ke {$registration->unit?->name} dan menunggu validasi.",
            'info',
    ...
    public function virtualAccountPoolEmpty(Registration $registration): void
    {
        ...
        $this->notify(
            ...
            "{$registration->unit?->name}: pendaftaran {$registration->full_name} tertahan karena tidak ada VA tersedia.",
            'danger',
    ...
    public function paymentProofUploaded(Payment $payment): void
    {
        ...
        $this->notify(
            ...
            "{$registration->full_name} telah mengunggah bukti pembayaran dan menunggu verifikasi sebelum nomor registrasi diterbitkan.",
            'warning',
