    ...
    @if($configurationUuid)
        <form wire:submit="save" class="space-y-6">
            ...
            <div class="flex flex-wrap gap-3">
                ...
                <x-filament::button wire:click="save(true)" wire:confirm="Publikasikan konfigurasi untuk pendaftar baru? Pendaftar lama tetap memakai versi sebelumnya." color="success">Publikasikan</x-filament::button>
            </div>
        </form>
