    ...
    <section id="pendaftaran" class="scroll-mt-24 bg-white py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl">
                ...
                <p class="mt-4 text-base leading-7 text-slate-600">Pilih jenjang untuk melihat pembukaan yang dapat didaftarkan sekarang.</p>
            </div>

            <div class="mt-8 flex flex-wrap gap-2" aria-label="Filter jenjang pendidikan">
