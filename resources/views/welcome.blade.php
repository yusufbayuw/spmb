...
<div class="text-center py-12">
    <div class="max-w-3xl mx-auto">
        ...
        <h1 class="text-4xl font-bold text-gray-800 mb-4">
            Selamat Datang di SPMB Taruna Bakti
        </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            ...
            <div class="bg-white rounded-xl p-6 card-shadow">
                ...
                <p class="text-gray-600 text-sm">Daftar secara online dari mana saja, kapan saja.</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow">
                ...
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Status Real-time</h3>
                <p class="text-gray-600 text-sm">Pantau status pendaftaran secara real-time.</p>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 card-shadow">
                ...
                <p class="text-gray-600 text-sm">Mendukung pendaftaran untuk semua unit sekolah.</p>
            </div>
        </div>
        ...
        <div class="mt-12 space-x-4">
            ...
            @else
                ...
                <a href="{{ route('login') }}" class="inline-block px-6 py-3 bg-white text-blue-800 rounded-lg font-semibold hover:bg-gray-50 transition shadow-md">
                    Login
                </a>
            @endauth
        </div>
